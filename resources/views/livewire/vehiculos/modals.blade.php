           ...
           <div class="modal-body">
				<form>
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="user_id" type="text" class="form-control" id="user_id" placeholder="User Id">@error('user_id') <span class="error text-danger">{{ $message }}</span> @enderror
